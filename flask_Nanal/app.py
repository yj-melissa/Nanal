...
def predict():
    ...
    model = joblib.load('model_logistic.pb')
    ...
    os.environ['JAVA_HOME'] = 'C:\Program Files\Zulu\zulu-8' # 환경변수 설정 로컬
    ...
    response = {"result": switch(result[0])}
    return flask.jsonify(response)


def switch(key):
    # 기쁨(0), 당황(1), 분노(2), 불안(3), 슬픔(4), 중성(5)
    return {0: "기쁨", 1: "당황", 2: "분노", 3: "불안", 4: "슬픔", 5: "중성"}.get(key)
