...
const RecycleBin = () => {
  ...
  return (
    <div className='relative w-[1440px] mx-auto'>
      ...
      <img src={nmb} className='absolute z-20 left-60 inset-y-28' />
      <img src={diaryImgBlue} className='absolute w-[1280px] z-10 left-12 top-8' />

      <div className='flex justify-center my-2'>
        {trashDiary.length > 0 ? <div className='absolute z-30 left-[240px] inset-y-72'>
          <button
      ...
      <div className='absolute z-20 justify-between mt-5 inset-y-28 right-60'>
        <div className='overflow-auto h-96 pr-2'>
